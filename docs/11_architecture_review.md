...
### البديل 1: اعتماد Inertia.js v3.0 (القرار النهائي) ✅

**Inertia.js v3.0** هو الخيار التقني النهائي لهذا المشروع، لما يوفره من تجربة مستخدم (UX) تضاهي التطبيقات المكتبية (Desktop-grade speed)، وهو أمر حيوي لمحلات البلايستيشن والرسيفرات التي تتطلب سرعة فائقة في التعامل.
