...
*النسخة v1.0 - تصميم مخصص لـ NativePHP*
...
### 🖥️ واجهة سطح المكتب (NativePHP)
- **Side Sidebar:** (ثابت) يحتوي على الأيقونات الرئيسية (POS, Inventory, Reports) لسرعة التنقل بين الأقسام.
- **Top Bar:** (ديناميكي) يحتوي على:
    - زر "بحث سريع عن سيريال" (Global Serial Search) متاح من أي مكان.
    - زر "فتح درج النقدية" (Open Drawer).
    - تنبيهات النظام (OS-level notifications indicator).
