...
2.  **نقطة البيع (POS Screen):** (الصفحة الأهم) بيع بالسيريال/الباركود، طباعة صامتة، سلة مشتريات سريعة.
3.  **المخزن الذكي (Inventory):** قائمة المنتجات، حالات السيريال (Available/Sold/Repair) والكميات.
4.  **إضافة مخزون (Inventory In):** استلام بضاعة جديدة بالسيريالات أو الكميات (Barcode Scanning Focus).
5.  **الجرد السريع (Stock Take):** واجهة مخصصة للمسح السريع ومقارنة الفروقات (PWA Optimized).
6.  **المرتجعات (Returns):** البحث برقم الفاتورة أو السيريال لإتمام المرتجع بسرعة.
